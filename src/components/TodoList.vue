<template>
  <div>
    ...
    :todo="todo" :index="index" :chekAll="!anyRemaining">
...
export default {
  ...
  created(){
    ...
    eventBus.$on('chekedAllChanged',(cheked) => this.checkAllTodos(cheked));
  ...
  beforeDestroy(){
    ...
    eventBus.$off('chekedAllChanged',(cheked) => this.checkAllTodos(cheked));
